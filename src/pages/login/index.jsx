...
function Login() {
    ...
    async function handleLogin() {
        ...
        const result = await axios.post("http://localhost:3000/auth/local/login", data, {withCredentials: true})
        if(result.status === 200) location.assign('/')
    }
            ...
            <div className="login-container">
                ...
                <div className="hehe">
                    ...
                    <div className="formlogin">
                        ...
                        <input type="text" ref={usernameInputRef} placeholder="Email" />
